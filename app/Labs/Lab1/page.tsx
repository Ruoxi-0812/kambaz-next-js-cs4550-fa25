...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h2>Lab 1</h2>
      <p>
        <strong>Ruoxi Wang — Section 01</strong>
      </p>
      <ul>
       <li>
       ...
       <Link href="/" id="wd-lab3-link">
        ...
        <p> Please{" "}
          <a href="https://github.com/Ruoxi-0812/kambaz-next-js-cs4550-fa25" id="wd-github">
            click here
          </a >{" "}
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>
            In a 10–12 oz microwave-safe mug, whisk 4 tbsp flour, 2 tbsp sugar,
            1 tbsp cocoa, and a pinch of salt.
          </li>
          <li>
            Stir in 3 tbsp milk, 1 tbsp oil, and 1/4 tsp vanilla until smooth.
          </li>
          <li>Microwave on HIGH 60–90 seconds, until the top is just set.</li>
          <li>Rest 1 minute.</li>
          <li>top with ice cream or syrup and enjoy!</li>
        </ol>
